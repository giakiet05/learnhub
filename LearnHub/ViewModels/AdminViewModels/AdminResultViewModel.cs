...
{
    public class AdminResultViewModel : BaseViewModel
    {
        ...
        public AdminResultViewModel()
        {
            SwitchToScoreInputCommand = new NavigateLayoutCommand(() => new AdminScoreInputViewModel());
            LoadGrades();
            LoadYears();
        }
