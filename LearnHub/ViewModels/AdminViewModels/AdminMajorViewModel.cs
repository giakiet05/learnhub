...
{
    public class AdminMajorViewModel : BaseViewModel
    {
        ...
        public ICommand SwitchToSubjectCommand { get; }

        public AdminMajorViewModel()
        {
            ...
            SwitchToSubjectCommand = new NavigateLayoutCommand(() => new AdminSubjectViewModel());
