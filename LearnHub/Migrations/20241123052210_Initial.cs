        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GKScore = table.Column<double>(type: "REAL", nullable: true),
                    CKScore = table.Column<double>(type: "REAL", nullable: true),
                    TXScore = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scores", x => new { x.SubjectId, x.Semester, x.YearId, x.StudentId });
                    table.CheckConstraint("CK_CKScore_Value", "[CKScore] BETWEEN 0 AND 10");
                    table.CheckConstraint("CK_GKScore_Value", "[GKSCore] BETWEEN 0 AND 10");
